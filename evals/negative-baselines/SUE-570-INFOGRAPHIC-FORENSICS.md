...
>
> The forensic analysis of why specific plates failed remains reusable research; its lane-level verdict is not.
> Any conclusion about production defaults, renderer choice, or lane usability must be re-derived under SUE-642..SUE-648.
